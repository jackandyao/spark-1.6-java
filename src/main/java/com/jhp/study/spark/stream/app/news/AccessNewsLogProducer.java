 ...
 *
 */
public class AccessNewsLogProducer extends Thread {
	...
	public AccessNewsLogProducer(String topic) {
		this.topic = topic;
	...
	public static void main(String[] args) {
		AccessNewsLogProducer producer = new AccessNewsLogProducer("adv-click-log");
		producer.start();
	}
